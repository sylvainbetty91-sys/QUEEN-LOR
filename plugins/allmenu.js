...
cmd({
    ...
    try {
        ...
        const botPP = config?.BOT_PP || config?.IMAGE_PATH || "https://files.catbox.moe/prkkzj.png";
        const channelLink = config?.CHANNEL_LINK || "https://whatsapp.com/channel/0029VarfjW04tRrmwfb8x306";
